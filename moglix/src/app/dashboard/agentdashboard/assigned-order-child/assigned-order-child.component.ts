...
@Component({
  selector: 'app-assigned-order-child',
  templateUrl: './assigned-order-child.component.html',
  styleUrls: ['./assigned-order-child.component.css']
})
export class AssignedOrderChildComponent implements OnInit {
