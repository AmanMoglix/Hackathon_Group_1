...
//	BCryptPasswordEncoder bCryptPasswordEncoder;
	...
	public String save(UserCO userCO) {
		...
		user.setRole(roleRepository.findByAuthority(userCO.getRole()));
	...
	public UserEntity saveEmployee(UserCO userCO, CurrentUser currentUser) {
		...
		UserEntity user=UserEntity.bind(this.getUserWithRoleMap(userCO));
		logger.info("Going to persist employee with role '{}'", new Gson().toJson(roleRepository.findByAuthority(userCO.getRole())));
	...
	@Override
	public UserEntity getById(Long userId, CurrentUser currentUser) {
