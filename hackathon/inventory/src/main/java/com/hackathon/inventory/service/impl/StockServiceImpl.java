...
public class StockServiceImpl implements StockService {
	...
	@Override
	public Stock findByProductIdAndSupplerId(Long productId, Long supplierId, CurrentUser currentUser) {
		return this.stockRepository.findByProductIdAndUserId(productId, supplierId);
	}
}
