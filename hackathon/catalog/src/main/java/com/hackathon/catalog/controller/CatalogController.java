...
//	public Catalog save(@RequestBody Catalog catalog) {
	public Catalog save(@RequestBody Catalog object,/*@RequestPart(required = false) MultipartFile files[],*/ @RequestHeader("X_AUTHORITY") String authority,
		...
		return catalogService.saveOrUpdate(object, currentUser);
	}
